...
def set_nbatches(category, n_train=n_train):
...
with tf.name_scope("recurrent_layer"):
    basic_cell = tf.contrib.rnn.BasicRNNCell(num_units=layer_size)          # , activation=tf.nn.relu
...
with tf.Session() as sess:
    ...
    #~ , global_step=epoch*1000000+step, 
    ...
    print("Test weighted F1 measure: ", test_f1)

    #~ show_loss_plot(loss_history, n_epochs)
