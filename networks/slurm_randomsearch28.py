...
if __name__ == "__main__":
    ...
    # 1c. Extend RNN model
    hpm_dict = retrieve_hyperparams("/mnt/scratch/thijs030/hpcnetworks/biGRU-RNN_28.txt")
    #~ hpm_dict = retrieve_hyperparams("/lustre/scratch/WUR/BIOINF/thijs030/networks/biGRU-RNN_28.txt")
