...
with tf.name_scope("recurrent_layer"):
    ...
    stacked_cells_fw = [set_cell(cell_type, size) for size in layer_sizes]
    stacked_cells_bw = [set_cell(cell_type, size) for size in layer_sizes]
