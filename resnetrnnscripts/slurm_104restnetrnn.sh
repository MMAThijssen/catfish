...
# NAME OF THE JOB
#SBATCH --job-name=ResNetRNN_randomsearch_104
...
# OUTPUT FILES
#SBATCH --output=out_trainingResNetRNN104_%j.txt
#SBATCH --error=error_trainingResNetRNN104_%j.txt
...
python3 $HOME_PATH/scripts/slurm_randomsearch104.py ResNetRNN \
